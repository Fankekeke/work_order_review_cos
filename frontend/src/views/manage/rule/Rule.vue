          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.ruleName" placeholder="请输入规则名称"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-select v-model="queryParams.isActive" placeholder="请选择状态">
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/audit-rule-library/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/audit-rule-library/page', {
        ...params
      }).then((r) => {
