<template>
  <a-modal v-model="show" title="修改模板流程" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='模板流程标题' v-bind="formItemLayout">
            <a-input v-decorator="[
            'title',
        ...
        <a-col :span="24">
          <a-form-item label='模板流程内容' v-bind="formItemLayout">
